...
var M = class extends import_react.default.Component {
  ...
  componentDidUpdate(t2) {
    null !== this.instance && M.updateObject(this.instance, t2, this.props);
  }
...
var S = class extends import_react.default.Component {
  constructor() {
  ...
  componentDidUpdate(t2) {
    null !== this.state.instance && S.updateObject(this.state.instance, t2, this.props);
  }
  componentWillUnmount() {
...
var U = class extends import_react.default.Component {
  constructor() {
  ...
  componentDidUpdate(t2) {
    null !== this.instance && U.updateControl(this.instance, t2, this.props);
  }
  componentWillUnmount() {
...
var Y = class extends import_react.default.Component {
  constructor() {
    super(), this.state = { instance: null }, this.instance = null;
  }
  componentDidMount() {
  ...
  componentDidUpdate(t2) {
    null !== this.state.instance && Y.updateObject(this.instance, t2, this.props);
  }
  componentWillUnmount() {
...
var H = class extends import_react.default.Component {
  constructor() {
  ...
  componentDidUpdate(t2) {
    null !== this.instance && H.updateObject(this.instance, t2, this.props);
  }
  componentWillUnmount() {
...
var K = class extends import_react.default.Component {
  constructor() {
    super(), this.state = { instance: null }, this.instance = null;
  }
  componentDidMount() {
    const { name: t2, ymaps: e2, dangerZone: n2 } = this.props, o2 = K.mountObject(n2 && "function" == typeof n2.modifyConstructor ? n2.modifyConstructor(e2[t2]) : e2[t2], this.props);
    this.instance = o2, this.setState({ instance: o2 });
  }
  componentDidUpdate(t2) {
    null !== this.instance && K.updateObject(this.instance, t2, this.props);
  }
  componentWillUnmount() {
